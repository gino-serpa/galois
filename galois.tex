...
\begin{proof}
Cal1 the column vectors of the matrix $C_1,\ldots,C_n$ and the 
...
Hence, the homogeneous equations have only the trivial solution\footnote{Of the preceding theory only Theorem 1, for

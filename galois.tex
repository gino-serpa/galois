...
\textbf{Remark:} Any $n$ independent vectors $A_1, \ldots, A_n$, in an $n$ dimensional vector space 
form a generating system. 
For any vector $A$ the vectors $A_1, \ldots ,A_n, A$ are dependent and the coefficient of $A$, in the
